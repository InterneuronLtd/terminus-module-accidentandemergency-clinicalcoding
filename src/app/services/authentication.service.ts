...
export class AuthenticationService {
    ...
    public async requestToken() {
        ...
        await this.httpClient.post("https://synapseidentityserver.azurewebsites.net/connect/token", "grant_type=client_credentials&client_id=client&client_secret=secret&scope=dynamicapi.read",
            { headers: headers })
